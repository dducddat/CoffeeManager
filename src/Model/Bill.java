...
public class Bill {
    ...
    public Bill(int ID, int EmployeeID, int CustomerID, int PaymentByID, int VoucherID, int Code, Date DateCreate, int Amount, String Address, boolean Status, Employee employee, Customer customer, PaymentBy paymentBy, ArrayList<BillDetail> listBillDetail) {
        this.ID = ID;
